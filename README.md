...
flowchart TB
  subgraph client [Your machine]
    ...
    CloudDb[(Cloud.sqlite identity and commerce)]
    HostUsersDb[(Users.sqlite hub)]
    UserDb[(users/*.sqlite Platform Vault)]
    TenantDb[(tenants/*.sqlite workspace SoR)]
...
4. Optional: install plugins under **Marketplace → Local** on self-host, or **Official** / **Community** on Cloud (see [docs/MARKETPLACE.md](docs/MARKETPLACE.md) and [docs/PLUGIN_AUTHORING.md](docs/PLUGIN_AUTHORING.md)).
...
| **Use GodMode** | [AGENT_MEMORY](docs/AGENT_MEMORY.md) · [MARKETPLACE](docs/MARKETPLACE.md) · [SHARED_FEDERATION](docs/SHARED_FEDERATION.md) · [CONFIGURATION](docs/CONFIGURATION.md) · [RELEASES](docs/RELEASES.md) · [SECURITY](docs/SECURITY.md) |
...
| **Project** | [CHANGELOG](CHANGELOG.md) · [CONTRIBUTING](CONTRIBUTING.md) · [Issues](https://github.com/ReBoticsAI/GodMode/issues) |
