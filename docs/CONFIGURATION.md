...
| `BACKUP_LOCAL_DIR` | `{data}/backups` | Local snapshot directory (stamps include `databases/Cloud.sqlite`, `core.sqlite` alias, `Users.sqlite`, `users/*.sqlite`, tenants, `plugin-data/`, timeseries) |
