...
- [Publisher / store connectors](features/publisher-store-connector-pattern.md) - Catalog pattern so Intelligence installs store/channel consoles as plugins, not Core identity.
