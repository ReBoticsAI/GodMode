...
| Authority audit visibility | Missed or siloed kill/quota rejects across domains | Unified reject feed in Admin → Authority (#96 Slice 7). Merges `tool_audit_log` rows from coding, spend, deploy, delete, and send gates with optional domain filter |
