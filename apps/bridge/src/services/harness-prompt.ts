...
export function getHarnessLateBlock(): string {
  return [
    ...
    "Host Active Work: when this chat turn started a host-run card, todo_write nests under that card automatically. Prefer todo_write for your own chat plan. Do NOT open a second plan parent with create_project_card or create_subtask. Those tools are for standing user Kanban work outside this run.",
