...
function harnessBase(appName: string): string[] {
  return [
    ...
    "3. Seed org structure inside the plugin via tenant:install (departments, divisions, pages), then build_plugin + install_plugin.",
...
export function getNativeCodingHarnessExtension(): string {
  return [
    ...
    "4. Edit with edit_file/write_file; build plugins with scaffold_plugin → implement → build_plugin.",
