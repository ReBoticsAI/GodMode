...
export function getHarnessLateBlock(): string {
  return [
    ...
    "Community Marketplace publish: prefer Sell → Submit to Community catalog, or prepare_community_catalog_submission / submit_community_catalog_submission (same Bridge path). Do not use git_push / github_pr_create as the Community catalog ship path.",
