...
export const AUTOMATION_SPECS: BuiltinSpec[] = [
  ...
  { name: "HookRun", label: "Hook Run", module: "automation", id: "hook_run_read", table: "hook_runs", database: "cloud", defaultSort: "created_at", actions: HOOK_RUN_ACTIONS, fields: ["id", "hook_id", "event_id", "status", "detail", ["result_json", "JSON"], "created_at"] },
