...
export const AUTOMATION_SPECS: BuiltinSpec[] = [
  ...
  { name: "PlatformEvent", label: "Platform Event", module: "automation", id: "platform_event_read", table: "platform_events", scope: "tenant", defaultSort: "created_at", fields: ["id", "type", "actor_kind", "actor_id", "tenant_id", ["payload_json", "JSON"], "created_at"] },
