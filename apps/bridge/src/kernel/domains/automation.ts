...
const WORKFLOW_ACTIONS: ActionDef[] = [
  { name: "run", label: "Run", target: "record", effect: "external", execution: "sync", roles: [...ownerRoles], confirmation: { required: true }, idempotency: { required: true }, inputSchema: { type: "object", properties: { input: {} }, additionalProperties: false } },
];
const WORKFLOW_RUN_ACTIONS: ActionDef[] = [
  { name: "resume", label: "Resume", target: "record", effect: "external", execution: "sync", roles: [...ownerRoles], confirmation: { required: true }, idempotency: { required: true }, inputSchema: { type: "object", properties: { input: {} }, additionalProperties: false } },
