...
describe("legacy route wave", () => {
  it("exposes only the approved specialized POST transports", () => {
    expect(declaredRoutes("post|put|patch|delete")).toEqual([
      ...
      "admin-saas.ts:post:/customers/:userId/soft-delete",
      "admin-saas.ts:post:/deletion-requests/:id/fulfill",
      "ai.ts:post:/chat",
      ...
      "marketplace.ts:post:/seller-link/exchange",
      "marketplace.ts:post:/seller-link/github-redirect",
      "marketplace.ts:post:/seller-link/poll",
      "marketplace.ts:post:/seller-link/start",
      "marketplace.ts:post:/seller-link/start-redirect",
      "marketplace.ts:post:/seller-link/stripe-redirect",
      "release-submissions.ts:post:/:id/refresh",
      "saas.ts:delete:/account/deletion",
      "saas.ts:delete:/seller-link/token",
      "saas.ts:post:/account/deletion",
      "saas.ts:post:/checkout",
      "saas.ts:post:/portal",
      "saas.ts:post:/seller-link/approve",
      ...
      "saas.ts:post:/seller-link/stripe-redirect",
      "saas.ts:post:/seller-link/stripe-redirect/complete",
      "saas.ts:post:/seller-link/stripe-refresh",
      "saas.ts:post:/seller-link/token",
