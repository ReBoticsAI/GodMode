...
export const buttonVariants = m.buttonVariants;
...
export const CardAction = m.CardAction;
export const CardDescription = m.CardDescription;
export const CardContent = m.CardContent;
export const Empty = m.Empty;
export const EmptyHeader = m.EmptyHeader;
export const EmptyTitle = m.EmptyTitle;
export const EmptyDescription = m.EmptyDescription;
export const EmptyContent = m.EmptyContent;
export const EmptyMedia = m.EmptyMedia;
export const Badge = m.Badge;
export const badgeVariants = m.badgeVariants;
export const Alert = m.Alert;
export const AlertTitle = m.AlertTitle;
export const AlertDescription = m.AlertDescription;
export const AlertAction = m.AlertAction;
